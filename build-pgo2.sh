...
time (export PATH=$HOME/clang-stage1/bin:$PATH; CLEAN=1 ./build-llvm.sh $HOME/clang-profile --disable-lldb --disable-clang-tools-extra --with-clang --disable-dylib --instrumented=Frontend)

time ./pgo-training.sh $HOME/clang-profile $HOME/clang-stage1
